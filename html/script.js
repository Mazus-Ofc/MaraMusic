$('#shutdownbutton').click(function() {
    $.post('https://MaraMusic/action', JSON.stringify({
        action: 'exit'
    }));
})
...
function getNameFile(url) {
	if (url == undefined) {
		...
		document.getElementById("testrec").innerHTML = "<b>Tocando:ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</b><marquee direction = 'left'> "+ vidname + "</marquee>"
	} else {
